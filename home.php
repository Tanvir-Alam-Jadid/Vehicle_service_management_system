    ...
    <div class="container h-100 d-flex align-items-end justify-content-center w-100">
        <div class="text-center text-white w-100">
            ...
            <div class="col-auto mt-5">
                <button class="btn btn-outline-warning btn-lg rounded-2" id="send_request" type="button">Send Service Request</button>
            </div>
        </div>
    </div>
</header>
    ...
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row">
            <div class="col-md-4">
                ...
                <hr class="bg-warning opacity-100">
                <ul class="list-group">
                    <?php 
            ...
            <div class="col-md-8">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-xl-2" id="service_list">
                    ...
                    <a class="col item text-decoration-none text-dark view_service" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">
                        <div class="callout callout-warning border-warning rounded-0">
                            <dl>
                ...
                <!-- <div id="noResult" style="display:none" class="text-center"><b>No Resut</b></div> -->
            </div>
        </div>
    </div>
</section>
